...
export class ContactService {
  ...
  public isFetching$ = this._isFetching$.asObservable()
  ...
  public getContactById(id: string): Observable<Contact> {
    ...
    return contact ? of(contact).pipe(tap(() => this._isFetching$.next(false))) : Observable.throw(`Contact id ${id} not found!`)
  }
